...
Answer:
1. target, response, effect
2. predictor, input, feature
...
Answer:
1. ensure data in correlation 
2. make it more easier to check out the data of single variables instead of observing the whole data.
