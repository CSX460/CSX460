...
library(caret)
library(magrittr)
load("D:/学习资料/UCB上/Practical of machine learning in R/CSX460/quizzes/binomial-performance/data.RData")
...
```{r}
test[MM='o',outcome] #how many are good and how many are bad
```
...
```{r}
fit.1 <- glm( outcome ~ . , data=train, family="binomial")
fit.2 <- glm( outcome ~ (.)^2, data=train,  family="binomial")
