...
A function is a block of code in a computer program. An algorithm is an abstract concept that describes how to solve a problem.
...
Because RMSE is more sentive to errors and errors can be better measured.
